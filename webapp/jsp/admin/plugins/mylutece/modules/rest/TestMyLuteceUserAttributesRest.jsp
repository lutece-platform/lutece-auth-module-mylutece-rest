...
<html>
    <head>
        <title>MyLutece - REST webservices test page</title>
        ...
        <script type="text/javascript">
            function onUserAttributesView(  ) {
                ...
                document.location= 'rest/mylutece/' + user_guid + format;
            }
            ...
            function onUserAttributeView(  ) {
                ...
                document.location= 'rest/mylutece/' + user_guid + '/' + attribute;
            }
        </script>
    </head>
    <body>
        <div id="content" >
            <h1>MyLutece User Attribute - REST webservices test page </h1>
            <div class="content-box">
            	<div class="highlight-box">
	                <h2>View WADL</h2>
	                <form action="rest/mylutece/wadl">
	                    <br/>
	            ...
	            <div class="highlight-box">
	                <h2>View MyLutece user attributes</h2>
	            ...
	            <div class="highlight-box">
	                <h2>View MyLutece user attribute</h2>
